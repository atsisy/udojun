...
enum TextureID {
	...
	LASER_TAIL3,
        ...
        SHINREI1_TX3,
        NAVY_BACKGROUND1,
        CIRCLE_WHITE_STROKE1,
        LIGHT_GLASS_BACKGROUND1,
        LEAF1,
        LEAF2,
        LOTUS_PINK,
        LOTUS_BLUE,
...
inline TextureID str_to_txid(const char *str)
{
	if (!strcmp(str, enum_to_str(BULLET_HART))) {
        ...
        str_to_idx_sub(str, NAVY_BACKGROUND1);
        str_to_idx_sub(str, CIRCLE_WHITE_STROKE1);

        str_to_idx_sub(str, LIGHT_GLASS_BACKGROUND1);

        str_to_idx_sub(str, LEAF1);
        str_to_idx_sub(str, LEAF2);

        str_to_idx_sub(str, LOTUS_PINK);
        str_to_idx_sub(str, LOTUS_BLUE);
        str_to_idx_sub(str, LOTUS_YELLOW);

        str_to_idx_sub(str, TITLE_BLUE);
