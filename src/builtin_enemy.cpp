...
namespace builtin_enemy {
        ...
        std::vector<EnemyCharacterMaterial> ghost_group1_hard(GameData *game_data)
        {
                std::vector<EnemyCharacterMaterial> ret;
                EnemyCharacterMaterial *p = game_data->get_enemy_material("REV_GHOST_ENEMY");
        ...
        std::vector<EnemyCharacterMaterial> nokogiri_ghost_group1_hard(GameData *game_data)
        {
                std::vector<EnemyCharacterMaterial> ret;
                EnemyCharacterMaterial *p = game_data->get_enemy_material("NOKOGIRI_GHOST_ENEMY_HARD");
        ...
        {
                std::vector<EnemyCharacterMaterial> ret;
                EnemyCharacterMaterial *a = game_data->get_enemy_material("GHOST_ENEMY4a_HARD");
                EnemyCharacterMaterial *b = game_data->get_enemy_material("GHOST_ENEMY4b_HARD");
                EnemyCharacterMaterial *c = game_data->get_enemy_material("GHOST_ENEMY5_HARD");
        ...
        std::vector<EnemyCharacterMaterial> ghost_group2_easy(GameData *game_data)
        {
                std::vector<EnemyCharacterMaterial> ret;
...
std::vector<std::function<std::vector<EnemyCharacterMaterial>(GameData *)>> builtin_enemy_funcs_hard = {
        builtin_enemy::ghost_group1,
        builtin_enemy::ghost_group1_hard,
        builtin_enemy::nokogiri_ghost_group1_hard,
        builtin_enemy::ghost_group2
};

std::vector<std::function<std::vector<EnemyCharacterMaterial>(GameData *)>> builtin_enemy_funcs_easy = {
        builtin_enemy::ghost_group1,
        builtin_enemy::nokogiri_ghost_group1,
        builtin_enemy::ghost_group2_easy
};
